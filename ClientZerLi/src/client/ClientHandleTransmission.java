...
public class ClientHandleTransmission {
	...
	public static void addOrder(BranchNames branchName,String greetingCard) {
		...
		int number = rndOrderNum.nextInt(999999);
		String orderID=String.format("%d", number);
		Order order =new Order(orderID,ClientController.user.getID(),branchName.name(),OrderHandleController.getTotalPrice(),
