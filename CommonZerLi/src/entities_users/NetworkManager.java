...
public class NetworkManager extends User implements Serializable{
	/**
	 * @param iD
	 * @param firstName
	 * @param lastName
	 ...
	 * @param isLoggedIn
	 */
	public NetworkManager(String iD, String firstName, String lastName, String email, String phoneNumber,
