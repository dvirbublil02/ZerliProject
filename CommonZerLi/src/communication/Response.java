...
<<<<<<< HEAD
	QUARTER_REPORT_NOT_FOUND("QUARTER_REPORT_NOT_FOUND",55),
	FOUND_QUARENTY_INCOME_REPORT("FOUND_QUARENTY_INCOME_REPORT",56),
	COMPLAINTS("NOT_FOUND_QUARENTY_INCOME_REPORT",57),
	REPORT_YEARS_NOT_FOUND("REPORT_YEARS_NOT_FOUND",58),
	REPORT_YEARS_FOUND("REPORT_YEARS_FOUND",59),
	SURVEY_REPORT_NOT_FOUND("SURVEY_REPORT_NOT_FOUND",60),
	SURVEY_REPORT_FOUND("SURVEY_REPORT_FOUND",61),
	INSERT_SURVEY_REPORT_FAILD("INSERT_SURVEY_REPORT_FAILD",62),
	INSERT_SURVEY_REPORT_SUCCESS("INSERT_SURVEY_REPORT_SUCCESS",63),
	NOT_FOUND_QUARENTY_COMPLAINTS_REPORT("NOT_FOUND_QUARENTY_COMPLAINTS_REPORT",64),
	FOUND_QUARENTY_COMPLAINTS_REPORT("NOT_FOUND_QUARENTY_COMPLAINTS_REPORT",65),
	NOT_FOUND_QUARENTY_INCOME_REPORT("NOT_FOUND_QUARENTY_INCOME_REPORT",66);
=======
