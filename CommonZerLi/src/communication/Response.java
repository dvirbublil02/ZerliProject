...
public enum Response {
	...
	IMPORT_DATA_FAILED("IMPORT_DATA_FAILED",78),
	GET_CUSTOMER_EMAIL_PHONE_SUCCESS("GET_CUSTOMER_EMAIL_PHONE_SUCCESS",79),
	GET_CUSTOMER_EMAIL_PHONE_FAILED("GET_CUSTOMER_EMAIL_PHONE_FAILED",80),
	UPDATE_DELIVERY_LATE_REFUND_FAILED("UPDATE_DELIVERY_LATE_REFUND_FAILED",81),
	UPDATE_DELIVERY_LATE_REFUND_SUCCESS("UPDATE_DELIVERY_LATE_REFUND_SUCCESS",82),
	ADDING_TO_THE_CATALOG_FAILED("ADDING_TO_THE_CATALOG_FAILED",83),
	ADDING_TO_THE_CATALOG_SUCCESS("ADDING_TO_THE_CATALOG_SUCCESS",84),
	REMOVE_FROM_THE_CATALOG_FAILED("REMOVE_FROM_THE_CATALOG_FAILED",85),
	REMOVE_FROM_THE_CATALOG_SUCCESS("REMOVE_FROM_THE_CATALOG_SUCESS",86),
	EDIT_PRODUCTS_ON_THE_CATALOG_FAILED("EDIT_PRODUCTS_ON_THE_CATALOG_FAILED",87),
	EDIT_PRODUCTS_ON_THE_CATALOG_SUCCESS("EDIT_PRODUCTS_ON_THE_CATALOG_SUCCESS",88);
