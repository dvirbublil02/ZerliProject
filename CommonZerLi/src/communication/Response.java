...
public enum Response {
	...
	GET_CUSTOMER_DETAILS_SUCCESS("GET_CUSTOMER_DETAILS_SUCCESS",78), 
	GET_CUSTOMER_DETAILS_FAILED("GET_CUSTOMER_DETAILS_FAILED",79), 
	GET_ALL_CUTOMERS_TO_NOTIFIY_FAILED("GET_ALL_CUTOMERS_TO_NOTIFIY_FAILED",80),
	GET_ALL_CUTOMERS_TO_NOTIFIY_SUCCEED("GET_ALL_CUTOMERS_TO_NOTIFIY_SUCCEED",81),

	
	CANCEL_ORDER_BY_CUSTOMER_SUCCESS("CANCEL_ORDER_BY_CUSTOMER_SUCCESS",82), 
	CANCEL_ORDER_BY_CUSTOMER_FAILD("CANCEL_ORDER_BY_CUSTOMER_FAILD",83), 
	GET_INFORMATION_USER_SUCCESS("GET_INFORMATION_USER_SUCCESS",84), 
	GET_INFORMATION_USER_FAILD("GET_INFORMATION_USER_FAILD",85);
