...
public enum Response {
	...
	COMPLAINTS("NOT_FOUND_QUARENTY_INCOME_REPORT",49),
	REPORT_YEARS_NOT_FOUND("REPORT_YEARS_NOT_FOUND",50),
	REPORT_YEARS_FOUND("REPORT_YEARS_FOUND",51),
	SURVEY_REPORT_NOT_FOUND("SURVEY_REPORT_NOT_FOUND",52),
	SURVEY_REPORT_FOUND("SURVEY_REPORT_FOUND",53),
	INSERT_SURVEY_REPORT_FAILD("INSERT_SURVEY_REPORT_FAILD",54),
	INSERT_SURVEY_REPORT_SUCCESS("INSERT_SURVEY_REPORT_SUCCESS",55),
	NOT_FOUND_QUARENTY_COMPLAINTS_REPORT("NOT_FOUND_QUARENTY_COMPLAINTS_REPORT",56),
	FOUND_QUARENTY_COMPLAINTS_REPORT("NOT_FOUND_QUARENTY_COMPLAINTS_REPORT",57),
	NOT_FOUND_QUARENTY_INCOME_REPORT("NOT_FOUND_QUARENTY_INCOME_REPORT",58);
