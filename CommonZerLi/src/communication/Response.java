...
public enum Response {
	...
	NOTIFY_CUSTOMER_SERVICE("NOTIFY_CUSTOMER_SERVICE",47), 
	UPDATE_ORDER_FAILED("UPDATE_ORDER_FAILED",48), 
	UPDATE_ORDER_SUCCEED("UPDATE_ORDER_SUCCEED",49), 
	GET_SURVY_QUESTION_FAILED("GET_SURVY_QUESTION_FAILED",50),
	GET_SURVY_QUESTION_SUCCEED("GET_SURVY_QUESTION_SUCCEED",51), 
	ISERT_SURVEY_SUCCEED("ISERT_SURVEY_SUCCEED",52),
	ISERT_SURVEY_FAILED("ISERT_SURVEY_FAILED",53);
