...
public enum Response {
	...
	FOUND_DELIVERIES("FOUND_DELIVERIES",47),
	NOT_FOUND_DELIVERIES("NOT_FOUND_DELIVERIES",48),
	UPDATE_DELIVERIES_STATUS_SUCCESS("UPDATE_DELIVERIES_STATUS_SUCCESS",49),
	UPDATE_DELIVERIES_STATUS_FAILED("UPDATE_DELIVERIES_STATUS_FAILED",50);
