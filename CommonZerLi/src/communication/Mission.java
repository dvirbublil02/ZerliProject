...
public enum Mission {
	...
	CANCEL_ORDER_BY_CUSTOMER("CANCEL_ORDER_BY_CUSTOMER",40), 
	GET_CUSTOMER_ORDERS_WAITING_CANCELATION("GET_CUSTOMER_ORDERS_WAITING_CANCELATION",41), 
	GET_INFORMATION_USER("GET_INFORMATION_USER",42);
