...
public enum Mission {
	...
	GET_CUSTOMER_DETAILS("GET_CUSTOMER_DETAILS",40), 
	GET_CUTOMER_TO_NOTIFY("GET_CUTOMER_TO_NOTIFY",41), 
	GET_BRANCH_NAME_BY_ID("GET_BRANCH_NAME_BY_ID",42),

	CANCEL_ORDER_BY_CUSTOMER("CANCEL_ORDER_BY_CUSTOMER",43), 
	GET_CUSTOMER_ORDERS_WAITING_CANCELATION("GET_CUSTOMER_ORDERS_WAITING_CANCELATION",44), 
	GET_INFORMATION_USER("GET_INFORMATION_USER",45);
